...
from sydr.dsp.acquisition import TwoCorrelationPeakComparison_SS, SerialSearch
from sydr.utils.constants import GPS_L1CA_CODE_SIZE_BITS, GPS_L1CA_CODE_FREQ
